...
class Work extends Component {
  constructor(props) {
    ...
    this.workDetails = [
      ...
      {
        number: '01',
        projectName: 'Pod-Genei',
        projectDesc: 'Artificial Intelligence Based PodCast Generator .',
        projectType: 'Project',
        roles: ['Author'],
      },
      {
        number: '02',
        projectName: 'Imagica-AI',
        projectDesc: "Artificial Intelligence Based Image Generator .",
        projectType: 'Project',
        roles: ['Author'],
      },
      {
        number: '03',
        projectName: 'Coin Crafter',
        projectDesc: 'Crypto Currency Exchange Platform.',
        projectType: 'Project',
        roles: ['Author'],
      },
      {
        number: '04',
        projectName: 'Coin Chronicle',
        projectDesc: 'Cyrpto Currency News Portal .',
        projectType: 'Project',
        roles: ['Author'],
      },
      {
