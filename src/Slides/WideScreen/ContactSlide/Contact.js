  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={twitterImg} alternate="twitter" redirectURL="https://x.com/GarvitPant777" />
          <SocialLogo imgURL={githubImg} alternate="github" redirectURL="https://github.com/Garvitpant777" />
          <SocialLogo imgURL={mailImg} alternate="mail" redirectURL="mailto:garvitpant777@gmail.com" />
          <SocialLogo imgURL={instaImg} alternate="insta" redirectURL="https://www.instagram.com/garvit_pant_777/" />
          <SocialLogo imgURL={dribbbleImg} alternate="dribbble" redirectURL="https://dribbble.com/" />
          <SocialLogo imgURL={linkedInImg} alternate="linkedin" redirectURL="https://www.linkedin.com/in/garvit-pant-ab4718201/" />
        </SocialMediaIcons>
      </Container>
    );
  }
